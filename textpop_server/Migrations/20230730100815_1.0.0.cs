        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageUri = table.Column<string>(type: "nvarchar(500)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MessageInfo_AspNetUsers_ReceiverUserId",
                        column: x => x.ReceiverUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_MessageInfo_AspNetUsers_SenderUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MessageInfo_ReceiverUserId",
                table: "MessageInfo",
                column: "ReceiverUserId");

            migrationBuilder.CreateIndex(
                name: "IX_MessageInfo_SenderUserId",
                table: "MessageInfo",
                column: "SenderUserId");
        }
